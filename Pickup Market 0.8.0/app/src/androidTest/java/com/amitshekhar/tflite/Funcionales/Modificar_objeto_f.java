...
public class Modificar_objeto_f {
    ...
    @Test
    public void modificar_objeto_u() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editText8), withText("descripcion silla"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.ScrollView")),
                                        0),
                                14)));
        appCompatEditText.perform(scrollTo(), replaceText("descripcion silla blanca"));

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText8), withText("descripcion silla blanca"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.ScrollView")),
                                        0),
