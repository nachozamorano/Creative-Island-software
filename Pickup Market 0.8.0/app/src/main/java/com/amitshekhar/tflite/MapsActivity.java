...
public class MapsActivity extends AppCompatActivity implements
    ...
    String HttpURL = "https://ecoruta.webcindario.com/BuscarObjeto.php";
    int latitud;
    int  longitud;
    String titulo;
    String estado;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        new MapsActivity.ParseJSonDataClass(this).execute();
    }

    private void Agregar_marcadores(int latitud, int longitud, String titulo, String estado) {
        if (estado == "libre") {
                    ...
                    if (FinalJSonResult != null) {
                        ...
                        try {
                            ...
                            for (int x=0; x < jsonArray.length(); x++) {
                                ...
                                latitud = jsonObject.getInt("latitud");

                                longitud =jsonObject.getInt("longitud");
                                titulo = jsonObject.getString("titulo").toString();
                                estado = jsonObject.getString("estado").toString();
                                Agregar_marcadores(latitud,longitud,titulo,estado);
                            }
