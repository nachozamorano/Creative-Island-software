    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView1.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(n>=1) {
                    ...
                    intent.putExtra("nombre_interesado", nombre_interesado[position+(5*n)]);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                listAdapter = new List_publicacion(hist_don.this, R.layout.custom_layout, SubjectList);
            ...
            protected void onPostExecute(String s)
            {
                ...
                try {
                    ...
                    if (jsonArray.length()==0){
                        Toast.makeText(hist_don.this, "Historial de donaciones vacio", Toast.LENGTH_SHORT).show();
                    }
