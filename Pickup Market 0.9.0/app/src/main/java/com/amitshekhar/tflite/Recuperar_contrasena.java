        ...
        class product extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s)
            {
                ...
                try {
                    ...
                    if(respuesta==true){
                        Toast.makeText(Recuperar_contrasena.this, "Contraseña enviada a Correo", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(Recuperar_contrasena.this,LoginActivity.class));
                    }
                    else {
                        Toast.makeText(Recuperar_contrasena.this, "Correo no valido", Toast.LENGTH_SHORT).show();
                    }
