...
public class Registro extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Categoria= (Spinner) findViewById(R.id.txtRegistro);
        ...
        insertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String mTelefono = telefono.getText().toString().trim();
                if(!mPass.isEmpty()||
                        !mNombre.isEmpty()||
                        !mTelefono.isEmpty()||
                        !mEmail.isEmpty()) {
    ...
    private boolean insertar(){
        ...
        nameValuePairs.add(new BasicNameValuePair("id_genero",String.valueOf(sexo.getSelectedItemPosition()+1)));
        nameValuePairs.add(new BasicNameValuePair("id_categoria",String.valueOf(Categoria.getSelectedItemPosition()+1)));
        try {
        ...
        class UserLoginClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(Registro.this, android.R.layout.simple_spinner_item,arreglo_c );
