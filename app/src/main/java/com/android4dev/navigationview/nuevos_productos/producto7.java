...
public class producto7 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio = (EditText) findViewById(R.id.nombreagregar20);
        dias = (TextView) findViewById(R.id.dias20);
        precio = (EditText) findViewById(R.id.precio14);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio20);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio14);
        boton_precio.setOnClickListener(this);
    }

    private void registro_inicio(){
        String inicios = inicio.getText().toString().trim();
        String dia = "producto7";
        if(ids==null) {
            Toast.makeText(getApplicationContext(), "Error", Toast.LENGTH_SHORT).show();
        }
        registrar(dia,inicios,ids,"7");
    }
    private void precio(){
        String precios = precio.getText().toString().trim();
        String promo = "producto7";
        if(ids==null) {
            Toast.makeText(getApplicationContext(), "Error", Toast.LENGTH_SHORT).show();
        }
        precio_nuevo(promo,precios,ids,"7");
    }
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(producto7.this,"Espere por favor",null,true,true);
            }
