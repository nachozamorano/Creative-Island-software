...
public class producto5 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio = (EditText) findViewById(R.id.nombreagregar18);
        dias = (TextView) findViewById(R.id.dias18);
        precio = (EditText) findViewById(R.id.precio12);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio18);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio12);
        boton_precio.setOnClickListener(this);
    }

    private void registro_inicio(){
        String inicios = inicio.getText().toString().trim();
        String dia = "producto5";
        if(ids==null) {
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(producto5.this,"Espere por favor",null,true,true);
            }
