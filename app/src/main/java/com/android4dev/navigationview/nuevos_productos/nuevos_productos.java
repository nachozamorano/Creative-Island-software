...
public class nuevos_productos extends ListFragment {
    String url="http://bishop94.000webhostapp.com/nuevos_precios.php";
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    for(int i=0;i < obj.length();i++){
                        devuelve[i]=obj.getJSONObject(i).getString("producto");
                        descripcion[i]=obj.getJSONObject(i).getString("precio");
                    }
                    final lenguaje_productos adapter=new lenguaje_productos(getActivity(),devuelve,imgid,descripcion);
