...
public class producto4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio = (EditText) findViewById(R.id.nombreagregar17);
        dias = (TextView) findViewById(R.id.dias17);
        precio = (EditText) findViewById(R.id.precio11);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio17);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio11);
        boton_precio.setOnClickListener(this);
    }

    private void registro_inicio(){
        String inicios = inicio.getText().toString().trim();
        String dia = "producto4";
        if(ids==null) {
            Toast.makeText(getApplicationContext(), "Error", Toast.LENGTH_SHORT).show();
        }
        registrar(dia,inicios,ids,"4");
    }
    private void precio(){
        String precios = precio.getText().toString().trim();
        String promo = "producto4";
        if(ids==null) {
            Toast.makeText(getApplicationContext(), "Error", Toast.LENGTH_SHORT).show();
        }
        precio_nuevo(promo,precios,ids,"4");
    }
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(producto4.this,"Espere por favor",null,true,true);
            }
