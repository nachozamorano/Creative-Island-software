...
public class promo3 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio = (EditText) findViewById(R.id.nombreagregar9);
        dias = (TextView) findViewById(R.id.dias9);
        precio = (EditText) findViewById(R.id.precio3);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio9);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio3);
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(promo3.this,"Espere por favor",null,true,true);
            }
