...
public class promo2 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio = (EditText) findViewById(R.id.nombreagregar8);
        dias = (TextView) findViewById(R.id.dias8);
        precio = (EditText) findViewById(R.id.precio2);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio8);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio2);
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(promo2.this,"Espere por favor",null,true,true);
            }
