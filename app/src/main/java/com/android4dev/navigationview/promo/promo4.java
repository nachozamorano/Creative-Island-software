...
public class promo4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promo4);
        inicio = (EditText) findViewById(R.id.nombreagregar10);
        dias = (TextView) findViewById(R.id.dias10);
        precio = (EditText) findViewById(R.id.precio4);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio10);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio4);
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(promo4.this,"Espere por favor",null,true,true);
            }
