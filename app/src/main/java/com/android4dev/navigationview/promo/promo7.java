...
public class promo7 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promo7);
        inicio = (EditText) findViewById(R.id.nombreagregar13);
        dias = (TextView) findViewById(R.id.dias13);
        precio = (EditText) findViewById(R.id.precio7);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio13);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio7);
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(promo7.this,"Espere por favor",null,true,true);
            }
