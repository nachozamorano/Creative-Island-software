...
public class promo6 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promo6);
        inicio = (EditText) findViewById(R.id.nombreagregar12);
        dias = (TextView) findViewById(R.id.dias12);
        precio = (EditText) findViewById(R.id.precio6);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio12);

        boton_inicio.setOnClickListener(this);
        boton_precio=(Button) findViewById(R.id.btnprecio6);
    ...
    private void registrar(final String dia,final String dia_dato,final String id,final String posicion){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(promo6.this,"Espere por favor",null,true,true);
            }
