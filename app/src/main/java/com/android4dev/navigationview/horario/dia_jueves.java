...
public class dia_jueves extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dia_jueves);
        inicio = (EditText) findViewById(R.id.nombreagregar3);
        cierre = (EditText) findViewById(R.id.apellidoagregar3);
        dias = (TextView) findViewById(R.id.dias3);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio3);
        boton_cierre = (Button) findViewById(R.id.btncierre3);
    ...
    private void registrar(final String dia,final String dia_dato,final String id){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dia_jueves.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(obj.isNull("error")){
                        Toast.makeText(dia_jueves.this,"modificado exitosamente",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(dia_jueves.this,obj.getString("error"),Toast.LENGTH_LONG).show();
                    }
