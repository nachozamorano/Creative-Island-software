...
public class dia_sabado extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dia_sabado);
        inicio = (EditText) findViewById(R.id.nombreagregar5);
        cierre = (EditText) findViewById(R.id.apellidoagregar5);
        dias = (TextView) findViewById(R.id.dias5);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio5);
        boton_cierre = (Button) findViewById(R.id.btncierre5);
    ...
    private void registrar(final String dia,final String dia_dato,final String id){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dia_sabado.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(obj.isNull("error")){
                        Toast.makeText(dia_sabado.this,"modificado exitosamente",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(dia_sabado.this,obj.getString("error"),Toast.LENGTH_LONG).show();
                    }
