...
public class dia_miercoles extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dia_miercoles);
        inicio = (EditText) findViewById(R.id.nombreagregar2);
        cierre = (EditText) findViewById(R.id.apellidoagregar2);
        dias = (TextView) findViewById(R.id.dias2);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio2);
        boton_cierre = (Button) findViewById(R.id.btncierre2);
    ...
    private void registrar(final String dia,final String dia_dato,final String id){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dia_miercoles.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(obj.isNull("error")){
                        Toast.makeText(dia_miercoles.this,"modificado exitosamente",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(dia_miercoles.this,obj.getString("error"),Toast.LENGTH_LONG).show();
                    }
