...
public class dia_lunes extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dia_edit);
        inicio = (EditText) findViewById(R.id.nombreagregar);
        cierre = (EditText) findViewById(R.id.apellidoagregar);
        dias = (TextView) findViewById(R.id.dias);
        id();

        boton_inicio = (Button) findViewById(R.id.btninicio);
        boton_cierre = (Button) findViewById(R.id.btncierre);
    ...
    private void registrar(final String dia,final String dia_dato,final String id){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dia_lunes.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(obj.isNull("error")){
                        Toast.makeText(dia_lunes.this,"modificado exitosamente",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(dia_lunes.this,obj.getString("error"),Toast.LENGTH_LONG).show();
                    }
