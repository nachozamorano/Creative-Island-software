...
public class dia_domingo extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dia_domingo);
        inicio = (EditText) findViewById(R.id.nombreagregar6);
        cierre = (EditText) findViewById(R.id.apellidoagregar6);
        dias = (TextView) findViewById(R.id.dias6);

        id();
        boton_inicio = (Button) findViewById(R.id.btninicio6);
        boton_cierre = (Button) findViewById(R.id.btncierre6);
    ...
    private void registrar(final String dia,final String dia_dato,final String id){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dia_domingo.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(obj.isNull("error")){
                        Toast.makeText(dia_domingo.this,"modificado exitosamente",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(dia_domingo.this,obj.getString("error"),Toast.LENGTH_LONG).show();
                    }
