...
public class dia_viernes extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dia_viernes);
        inicio = (EditText) findViewById(R.id.nombreagregar4);
        cierre = (EditText) findViewById(R.id.apellidoagregar4);
        dias = (TextView) findViewById(R.id.dias4);


        boton_inicio = (Button) findViewById(R.id.btninicio4);
        boton_cierre = (Button) findViewById(R.id.btncierre4);
    ...
    private void registrar(final String dia,final String dia_dato,final String id){
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(dia_viernes.this,"Espere por favor",null,true,true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if(obj.isNull("error")){
                        Toast.makeText(dia_viernes.this,"modificado exitosamente",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(dia_viernes.this,obj.getString("error"),Toast.LENGTH_LONG).show();
                    }
