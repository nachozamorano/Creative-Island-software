...
$Buscar = "SELECT objeto.id_objeto, objeto.id_propietario, objeto.nombre_objeto, objeto.descripcion, objeto.imagen, objeto.subcategoria, objeto.fecha_publicacion, objeto.fecha_expiracion, estado_objeto.nombre_estado_objeto, objeto.cantidad, unidad_medida.unidad_medida, objeto.Latitud, objeto.Longitud, objeto.desde, objeto.hasta, objeto.direccion FROM objeto INNER JOIN transaccion ON transaccion.id_objeto = objeto.id_objeto INNER JOIN usuario ON usuario.id_usuario = transaccion.id_dueno INNER JOIN estado_objeto ON estado_objeto.id_estado_objeto = objeto.id_estado_objeto INNER JOIN unidad_medida ON unidad_medida.id_unidad = objeto.id_unidad WHERE usuario.id_usuario = '$id_usuario'";
