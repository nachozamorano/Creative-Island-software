...
public class Modificar extends AppCompatActivity  implements View.OnClickListener {
    ...
    EditText etFecha, Nombre, Fecha_de_expiracion, direccion, Descripcion, numero,desde,hasta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSetImage.setImageResource((Integer) b.get("image"));
        ...
        desde.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ub.putExtra("image",(Integer) b.get("image"));
